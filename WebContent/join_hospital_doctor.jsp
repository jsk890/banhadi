...
<head>
    ...
    <style>
        ...
        /*인증하기,병원찾기 버튼*/
        .certification, .btn_searchHospital {
            left: 360px;
            width: 100px;
            height: 34px;
            color: #888;
...
<div id="content">
    ...
    <div id="veterinarianSignUp">
        <h2><i class="fas fa-user-md"></i> 수의사 회원가입</h2>
    ...
    <form id="formBox" method="post" enctype="multipart/form-data" onsubmit="return false;">
		...
		<input type="hidden" id="position" name="position" value="d"/>
...
function fn_join(){
	...
	$.ajax({
		url:"/ajax/HospitalDoctorJoin.json",
		type:"post",
